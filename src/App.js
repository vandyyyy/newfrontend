...
import FeaturedProduct from "./components/Route/FeaturedProduct/FeaturedProduct";
//import ProjectDetailsPage from "./productDetails";
import ProductDetailsCard from "./components/Route/ProductDetailsCard/ProductDetailsCard";
import ProductDisplayPage from "./components/Route/FeaturedProduct/ProductDisplayPage";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/events" element={<ProductDetailsCard />} />
